...
export default function Dashboard() {
  ...
  return (
    <div className="p-6 max-w-xl mx-auto text-center">
      ...
      {!accessToken && (
        <p>
          No tokens found in URL. Please include access_token, refresh_token,
          and expires_in as query params.
        </p>
      )}
      ...
      {accessToken && (
        <div className="bg-gray-100 rounded p-4 text-left space-y-4">
          <div>
            ...
            <code className="block overflow-auto break-all bg-white p-2 border rounded">
              {accessToken}
            </code>
          </div>
          <div>
          ...
          <div className="mt-4 p-3 rounded border">
            ...
            {saveStatus === "idle" && (
              <p className="text-gray-600">Ready to save...</p>
            )}
            {saveStatus === "saving" && (
              <p className="text-blue-600">💾 Saving tokens to Supabase...</p>
            )}
            {saveStatus === "success" && (
              <p className="text-green-600">✅ Tokens saved successfully!</p>
            )}
            {saveStatus === "error" && (
              <div>
